...
use App\Http\Controllers\dashboard\export\AdvertisementExportController;
...
Route::group(["middleware" => "notLogin"], function () {
    ...
    Route::group(["prefix" => "export", "as" => "export."], function () {
        Route::get('/advertisement', [AdvertisementExportController::class, "advertisement"])->name("advertisement");
